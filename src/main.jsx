/* agent-lock — watch a Landlock-confined omp and prove the jail holds.
 *
 * This is the WATCHER (the observability half). The `agent-lock` command (the
...
if (headless) {
  ...
  console.error(`agent-lock: headless ${mode} mode — reporting escape attempts for ${dir}`);
